              ...
              <div class="container_edit">
                <div class="row">
                    <div class="column" style="width: 33.3%;">
                      ...
                      <div src="#" style="width: 200px; height: 200px; border: 1px; background-color: #ddd; margin-left: 40px;"><img <?php echo "<img src='../admin/images/employee/".$user_data['image']."'"; ?> ></div>
                      <input type="hidden" name="id" value="<?php echo $user_data['id']; ?>">
                      <div style="margin-left: 40px;"><input type='file' name="" onchange="readURL(this);" disabled="" /></div>
                    </div>
                    <div class="column" style="width: 33.3%;">
                ...
                <div class="row">
                  <h2 style="text-align: center;">Employee Personal Information</h2><br>
                    <div class="column" style="width: 33.3%;">
                      ...
                      <div src="#" class="img_emp"><img id="pic" <?php echo "<img src='../admin/images/employee/".$user_data['image']."' >"; ?>/></div>

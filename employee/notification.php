...
?>
                ...
                <tr>
                  ...
                  <td><input type='text' name="subject" value="Monthly Due Payment" required style="border-radius: 50px;"></input></td>
                </tr>
                <tr>
                  <td> </td>
                  <td><textarea class="ta_notif" name="message" placeholder="Compose email..."><?php echo 'Hello Admin here We would like to remind you to pay your monthly due of 200php through Gcash or etc.'; ?></textarea></td>
                </tr>
                <tr>
      ...
      <div id="sidebar">
        ...
        <div class="sidebar__menu">
          ...
          <div class="sidebar__link">
            ...
            <a href="employee_profile.php">Admin Profile</a>
          </div>
          <div class="sidebar__link">

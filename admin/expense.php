      ...
      <main>
       <div>  
          <div class="card-header">
            ...
            <a href="expense_total.php" class="btn_action"><b>Report</b></a>
          </div>
          ...
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                    ...
                    <a href="expense_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-remove text-remove" title="Delete"></i></a>
                </td>
              </tr>
          <?php endwhile; ?>
          </table>

...
<?php
  ...
  <?php endif ?>
          ...
          <thead>  
              <tr> 
                <th style="text-align:left; width: 30%"><b>Information</b></th>
        ...
        <?php
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                    <a href="work_notif.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-envelope" title="Send Notification"></i></a>
                    <a  href="work_order_update.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-edit text-edit" title="Update"></i></a>
                    <a href="work_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-remove text-remove" title="Delete"></i></a>
                </td>
              </tr>
          <?php endwhile; ?>
          </table>

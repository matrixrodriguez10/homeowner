...
?>
      ...
      <main>
       <div>  
          <div class="card-header_expense" id="user">
            Update Expense 
          </div>
          <form action="expense_crud.php" method="post">
              <div class="container_xpnsedit">
                    <div class="column_expense_edit">
                      <input type="hidden" name="id" value="<?php echo $id; ?>">
                      <label>Category:</label><span><input    type="text" name="category" required="" value="<?php echo $category; ?>"></span>
                      <label>Payment:</label><span><input type="text" name="payment" required="" value="<?php echo $payment; ?>"></span>
                      <label>Date of Payment:</label><span><input type="date" name="dpay" required="" value="<?php echo $dpay; ?>"></span>
                    </div>
                    <button class="button_update" name="update" type="submit">Update</button>
              </div>
          </form> 
        </div>
      </main>

...
?>
            ...
            <a href="employees_record.php"><div class="card">
              <i class="fa fa-user-plus fa-4x text-yellow" aria-hidden="true" style="text-align: center;"></i>
              <div class="card_inner">
                <p class="text-primary-p">Employees <br>
<?php
...
?>
            ...
            <a href="invoice.php"><div class="card">
              <i class="fa fa-calendar fa-4x text-red" style="text-align: center;" aria-hidden="true"></i>
              <div class="card_inner">
...
?>
            ...
            <a href="expense.php"><div class="card">
              <i class="fa fa-calculator fa-4x text-green" style="text-align: center;" aria-hidden="true"></i>
              <div class="card_inner">
                <p class="text-primary-p">Expenses <br>
...
?>
          ...
          <div class="charts">
            ...
            <div class="charts__right" style="width: 950px;">
              ...
              <a href="covid19_tracker.php"><div class="charts__right__cards">
                <div class="card1">
                  <h1><i class="fa fa-user-md"></i> Covid-19 Tracker</h1><br>
                  <h3>
...
?>
                ...
                <a href="visitors_record.php"><div class="card2">
                  <h1><i class="fa fa-male"></i> Visitors</h1><br>
                  <h3>

...
?>
        ...
        <?php
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                  ...
                  <td><?php echo $row['homename']; ?></td>
                <td>
                    
                    <a  href="visitors_edit.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-edit text-edit" title="Update"></i></a>
                    <a href="visitors_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-remove text-remove" title="Delete"></i></a>
                </td>
              </tr>
          <?php endwhile; ?>
          </table>
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content" style="background-color: #0D7F05;">
          ...
          <p class="sign"><b>CREATE GATE PASS</b></p>
        </div>
              ...
              <div class="container_s wow fadeInDown delay-03s">
                <div class="row">
                    <div class="column">
                      ...
                      <label>Date:</label><span><input type="date" name="date" required></span><br>
                      <label>Time in:</label><span><input type="text" name="time" required></span>  
                    </div>

                    <div class="column">
                        <label>Contact #:</label><span><input  type="text" name="contact" required> </span>
                        <label>Relation to Homeowner:</label><span><input  type="text" name="relation" required></span>
                        <label>Homeowner's Name:</label><span><input type="text" name="homename" required></span>
                    </div>
                    <button class="button_s" type="submit" name="save">CREATE</button>
                </div>
              </div>
          </form> 
      </div>

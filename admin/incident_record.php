  ...
  <?php endif ?>
            ...
            <thead>
              <tr>
                ...
                <th style="width: 18%;"><b>Information</b></b></th>
          ...
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                    ...
                    <a href="incident_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-remove text-remove" title="Delete"></i></a>
                </td>
              </tr>
          <?php endwhile; ?>
          </table>

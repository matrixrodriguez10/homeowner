  ...
  <?php endif ?>
            ...
            while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                    <a href="cert.php?edit=<?php echo $row['id']; ?>" onclick="location.reload();" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Generate</a>&nbsp;
                    <a href="notification_cert.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-envelope" title="Send Notification"></i></a>&nbsp;
                    <a href="residency_update.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-edit text-edit" title="Update"></i></a>&nbsp;
                    <a href="residency_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-trash" title="Delete"></i></a>                   
                </td>
              </tr>
            <?php endwhile; ?>
          </table>
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content" style="background-color: #0D7F05; margin-top: -50px;">
          ...
          <p class="sign"><b>CREATE CERTIFICATE OF RESIDENCY</b></p>
        </div>

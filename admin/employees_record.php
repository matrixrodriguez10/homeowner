      ...
      <main>
        <div>	
          <div class="card-header" id="user">
            <p style="float: left; font-size: 30px;">Employee's List</p>
...
<?php require_once 'employee_crud.php'; ?>
        ...
        <?php
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td><?php echo "<img src='images/employee/".$row['image']."' >"; ?></td>
                ...
                <td colspan="2">
                  <a href="employee_edit.php?edit=<?php echo $row['id']; ?>"><i class="fa fa-edit text-edit" title="Update"></i></a>
                  
                  <a href="employee_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-remove text-remove" title="Delete"></i></a></a>
                </td>
              </tr>
          <?php endwhile; ?>
          </table>
...
<?php
  ...
  if(isset($_POST['upload'])) {
    ...
    $sql = "INSERT INTO employee (user_id, image, firstname, lastname, username, password, contact, bday, email, position, address) VALUES ('$user_id', '$image', '$firstname', '$lastname', '$username', '$password', '$contact', '$bday', '$email', '$position', '$address')";
...
?>
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content modal_emp" >
          ...
          <form action="employees_record.php" method="post" enctype="multipart/form-data">
              <div class="create_emp">
                <div class="row">
                  <h2 style="text-align: center;">Employee Personal Information</h2><br>
                    ...
                    <div class="column" style="width: 33.3%;">
                        ...
                        <label>Position:</label><span><input    type="text" name="position" required=""></span>
                    </div>
                    <div class="emp_address"><label>Address:</label><span><input type="text" name="address" required=""></span></div>

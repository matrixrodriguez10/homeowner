      ...
      <main>
        <div class="table_contadiner">	
          <div class="card-header" id="user">
            <p style="float: left; font-size: 30px;">Collection</p>
            <form  action="#" style=" float: left;">
              
              <input type="search" name="search2" id="myInput" style="width: 350px; height: 40px; margin-left: 50px;">
          ...
          while ($row = $result->fetch_assoc()): ?>
              <tr>
                ...
                <td>
                    ...
                    <a href="invoice_crud.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to Delete this info?');"><i class="fa fa-trash text-remove" title="Delete"></i></a>

...
?>
                ...
                <tr>
                  ...
                  <td><input type='text' name="subject" value="Work Request" required style="border-radius: 50px;"></input></td>
                </tr>
                <tr>
                  <td> </td>
                  <td><textarea class="ta_notif" name="message" placeholder="Compose email..."></textarea></td>
                </tr>
                <tr>

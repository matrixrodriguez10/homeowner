    ...
    <div class="container">
          ...
          <div class="card-header" id="user">
            ...
            <table id="user" style="background-color: white; width: 100%;">
              <tr>
                ...
                <td style="width: 25%;"><b>Information</b></b></td>
                <td><b>Category</b></td>
              ...
              <?php
                    ...
                    $squery = mysqli_query($conn, "SELECT * FROM work p left join users r on r.id = p.user_id WHERE r.id = ".$user_data['id']." ");
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content" style="background-color: #0D7F05; margin-top: -50px;">
          ...
          <p class="sign"><b>REQUEST MAINTENANCE</b></p>
        </div>
              ...
              <div class="container_s wow fadeInDown delay-03s">
                <div class="row">
                    <div class="column">
                      ...
                      <span><input type="hidden" name="status" value="Pending"></span>
                    </div>
                    ...
                    <div class="column">
                        ...
                        <label>Description of Request:</label><span><textarea name="description" required=""></textarea> </span>  
                    </div>

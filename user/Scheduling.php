    ...
    <div class="container">
      ...
      <main>
        <div class="table_contadiner">  
          <div class="card-header" id="user">
            ...
            <button id="myBtn" class="btn_action"><b>Request</b></button>
          </div>
          ...
          <tbody id="myTable">  
              <?php
                    ...
                    $squery = mysqli_query($conn, "SELECT * FROM scheduling p left join users r on r.id = p.user_id WHERE r.id = ".$user_data['id']." ");
      ...
      <div id="myModal" class="modal">
        ...
        <div class="modal-content" style="background-color: #0D7F05; margin-top: -50px;">
          ...
          <p class="sign"><b>REQUEST SCHEDULE</b></p>
        </div>
          <form action="scheduling_crud.php" method="post">
              <div class="container_s">
                <div class="row">
                    ...
                    <div class="column">
                        <span><input  type="hidden" name="status" readonly="" value="Pending"> </span>
                        <label>Date of Reservation:</label><span><input  type="date" name="date" required=""> </span>
                    ...
                    <button class="button_emp" name="save" type="submit" > REQUEST</button>
                </div>
              </div>
          </form> 
      </div>
